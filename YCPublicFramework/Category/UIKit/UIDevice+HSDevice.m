...
@implementation UIDevice (HSDevice)
...
+ (NSString *)hs_devicePlatformString {
    NSString *platform = [self hs_devicePlatform];
    // iPhone
...
+ (BOOL)hs_isiPad {
    return [[[self hs_devicePlatform] substringToIndex:4] isEqualToString:@"iPad"];
}

+ (BOOL)hs_isiPhone {
    return [[[self hs_devicePlatform] substringToIndex:6] isEqualToString:@"iPhone"];
}

+ (BOOL)hs_isiPod {
    return [[[self hs_devicePlatform] substringToIndex:4] isEqualToString:@"iPod"];
}

+ (BOOL)hs_isSimulator {
    return [[self hs_devicePlatform] isEqualToString:@"i386"]
    || [[self hs_devicePlatform] isEqualToString:@"x86_64"];
}
